...
const SubmitForm: React.FC = () => {
  ...
  return (
    <div className="mx-auto h-screen bg-[#f5f5f5] pt-40 px-5">
      ...
      <div className="flex items-center justify-center gap-8 py-5">
        <div className="bg-white shadow rounded-xl w-[800px] h-[560px] relative overflow-hidden">
          <form onSubmit={handleSubmit} className="">
            <div className="py-5 w-full flex flex-col gap">
              <h1 className="text-[#141516] font-bold text-4xl text-center">
                Submit Assignment
              </h1>
              ...
              <div className="pt-5 px-6">
                <div className="flex items-center justify-between px-5">
                  <div className="group w-[330px]">
                    ...
                    <input
                      ...
                      className="w-full text-black p-2 border-b-2 border-[#8d8d8d] focus:outline-none focus:border-black transition-colors duration-300"
                      required
                    />
                  </div>
                  <div className="group w-[330px]">
                ...
                <div className="flex items-center justify-between px-5 pt-3">
                  ...
                  <div className="group w-[330px]">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full text-black p-2 border-b-2 border-[#8d8d8d] focus:outline-none focus:border-black transition-colors duration-300 bg-transparent"
                      required
                    >
                ...
                <div className="group w-full px-5 pt-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full text-black p-2 pr-20 border-b-2 border-[#8d8d8d] focus:outline-none focus:border-black transition-colors duration-300"
                      required
                    />
                    <button
                      type="button"
                ...
                <div className="group w-full px-5 pt-3">
                  ...
                  <div className="pt-5 relative">
                    ...
                    <button
                      type="submit"
                      className={`px-4 py-2 rounded w-[200px] h-[54px] text-md font-bold ${
                        submissionExists || isButtonDisabled || isSubmitting
                          ? "bg-gray-400 cursor-not-allowed"
                          : "bg-[#25c3ec] hover:bg-[#1da8cc]"
                      } text-white`}
                      disabled={
                        submissionExists || isButtonDisabled || isSubmitting
                      }
        ...
        <div className="bg-[#1e1e1e] h-[560px] w-[558px] rounded-xl shadow text-white flex items-center justify-center">
          <div className="">
            <div className="">
              <h1 className="text-[40px] font-bold px-16 pl-16">
                Your talent could be the next big thing{" "}
                <span className="text-[#25c3ec]">we’re waiting</span> for.
              </h1>
            </div>
      ...
      <div className="flex items-center justify-between px-20">
        ...
        <div className="text-[#1e1e1e] opacity-50">
          @ 2023 Dezainahub! |{" "}
          <span
        ...
        <div className="flex gap-3">
          <button
            ...
            className="bg-[#1e1e1e] rounded-full w-[27px] h-[27px] flex items-center justify-center"
          >
